...
const en = {
  ...
  "look.cameraMatchHint": "Toward the camera's own JPEG: the engine's Advanced highlight roll-off (without its 3-D LUT, which pulls saturated colour down) plus a correction fitted per body, Creative Look and Fade state on what is left — up to ±4 L* of lightness, ±5% of chroma and ±2° of hue, applied to the finished frame. Only offered on bodies the correction was fitted for.",
  ...
  // Library: folder tree + grid
  "view.library": "Library",
  "view.develop": "Develop",
  "tree.title": "Folders",
  "tree.root": "Library",
  "tree.newFolder": "New folder",
  "tree.newFolderName": "New folder",
  "tree.rename": "Rename",
  "tree.delete": "Delete folder",
  "tree.deleteConfirm": "Delete “{name}” and the {n} photos in it? The original files on disk are untouched.",
  "tree.importFiles": "Import files…",
  "tree.importFolder": "Import folder…",
  "tree.empty": "Drop files or folders here",
  "grid.empty": "No photos in this folder yet — drop files here to import them",
  "grid.loading": "Loading…",
  "grid.selected": "{n} selected",
  "grid.open": "Open in Develop",
  "grid.remove": "Remove from library",
  "grid.removeConfirm": "Remove {n} photos from the library? The original files on disk are untouched.",
  "grid.dragCount": "{n} photos",
  "status.importProgress": "Importing {done}/{total}",
  "status.importFailed": "{n} files could not be imported",
...
const zh: Record<MessageKey, string> = {
  ...
  "look.cameraMatchHint": "贴近机内 JPEG：用引擎高级档的高光滚降（不带会压饱和的 3D LUT），再叠一层按机身、创意外观和褪色档拟合的残差修正——亮度 ±4 L*、色度 ±5%、色相 ±2°，作用在最终成片上。只在拟合过的机身上可用。",
  ...
  "tree.rename": "重命名",
  "tree.delete": "删除文件夹",
  "tree.deleteConfirm": "删除“{name}”及其中的 {n} 张照片？磁盘上的原文件不受影响。",
  "tree.importFiles": "导入文件…",
  "tree.importFolder": "导入文件夹…",
  "tree.empty": "把文件或文件夹拖到这里",
  "grid.empty": "此文件夹还没有照片——把文件拖到这里导入",
  "grid.loading": "加载中…",
  "grid.selected": "已选 {n} 张",
  "grid.open": "在编辑视图中打开",
  "grid.remove": "从图库移除",
  "grid.removeConfirm": "从图库移除 {n} 张照片？磁盘上的原文件不受影响。",
  "grid.dragCount": "{n} 张照片",
  "status.importProgress": "导入中 {done}/{total}",

...
const en = {
  ...
  "look.cameraMatchHint": "Toward the camera's own JPEG: the engine's Advanced highlight roll-off (without its 3-D LUT, which pulls saturated colour down) plus a correction fitted per body and Creative Look on what is left — up to ±3 L* of lightness, ±5% of chroma and ±2° of hue, applied to the finished frame. Only offered on bodies the correction was fitted for.",
...
const zh: Record<MessageKey, string> = {
  ...
  "look.cameraMatchHint": "贴近机内 JPEG：用引擎高级档的高光滚降（不带会压饱和的 3D LUT），再叠一层按机身和创意外观拟合的残差修正——亮度 ±3 L*、色度 ±5%、色相 ±2°，作用在最终成片上。只在拟合过的机身上可用。",

...
const en = {
  ...
  "engine.sonyUnavailable": "This shot fell back to the DCP profile: Black & White and Sepia are desaturated in stages this pipeline does not reproduce, and a non-Sony RAW carries no Sony calibration at all.",
  ...
  "settings.look": "Look",
  "look.lightroom": "Lightroom-style",
  "look.agx": "AgX (filmic)",
...
const zh: Record<MessageKey, string> = {
  ...
  "engine.adobe": "Adobe（DCP）",
  "engine.sony": "Sony Imaging Edge",
  "engine.sonyUnavailable": "这张已回落到 DCP 配置文件：黑白与棕褐色的去色发生在本管线未复刻的阶段，而非索尼 RAW 根本不带 Sony 标定。",
  "settings.creativeLook": "创意外观",
  "settings.dcp": "DCP 样式",
  "settings.cameraMatch": "相机匹配",
  "settings.cameraMatchHint": "将配置文件校正到该相机自己的 JPEG 直出效果",
  "settings.look": "呈现风格",
  "look.lightroom": "Lightroom 风格",
  "look.agx": "AgX（胶片感）",
  "settings.display": "显示",
